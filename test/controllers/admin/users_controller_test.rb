...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { email: @admin_user.email, first_name: @admin_user.first_name, last_name: @admin_user.last_name, slug: @admin_user.slug }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { email: @admin_user.email, first_name: @admin_user.first_name, last_name: @admin_user.last_name, slug: @admin_user.slug }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
